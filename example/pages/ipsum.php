...
?>
	<!--CUSTOM <head /> for upsum page-->
	<title>jQuery Router</title>
	<meta name="description" content="This is the ipsum page of my site" />
	...
	<meta property="og:description" content="This is the ipsum page of my site" />
<?php
...
<article>
	<h2>Sample Ipsum page</h2>
	<p>Put your ipsum page content here</p>
</article>
<?php
	if ($isCrawler) {
